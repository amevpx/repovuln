...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BINLIBDEST': '/tmp/python/lib/python3.9',
 'BLDLIBRARY': 'libpython3.9.a',
 'BLDSHARED': 'gcc -shared -Wl,--strip-all',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIG_ARGS': "'--build=x86_64-linux-gnu' "
                ...
                "'--with-system-expat' 'build_alias=x86_64-linux-gnu'",
 'CONFINCLUDEDIR': '/tmp/python/include',
 'CONFINCLUDEPY': '/tmp/python/include/python3.9',
 'COREPYTHONPATH': '',
 ...
 'CXX': 'g++',
 'DESTDIRS': '/tmp/python /tmp/python/lib /tmp/python/lib/python3.9 '
             '/tmp/python/lib/python3.9/lib-dynload',
 'DESTLIB': '/tmp/python/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '/tmp/python/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/tmp/python/include /tmp/python/include '
                   '/tmp/python/include/python3.9 '
                   '/tmp/python/include/python3.9',
 'INCLUDEDIR': '/tmp/python/include',
 'INCLUDEPY': '/tmp/python/include/python3.9',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -shared -Wl,--strip-all',
 'LDVERSION': '3.9',
 'LIBC': '',
 'LIBDEST': '/tmp/python/lib/python3.9',
 ...
 'LIBPL': '/tmp/python/lib/python3.9/config-3.9-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/tmp/python/lib/python3.9',
 ...
 'PY_CORE_LDFLAGS': '-Wl,--strip-all',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,--strip-all',
 'PY_LDFLAGS_NODIST': '',
